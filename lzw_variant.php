...
$myfile2=fopen("test_lzw_variant.txt","w") or die("unable to open file");
...
$myfile3=fopen("test_lzw_variant.txt","r") or die("unable to open the file");
$j=0;
while(!feof($myfile3))
{
	fgetc($myfile3);	
...
$myfile4=fopen("test_lzw_variant.txt","r") or die("unable to open the file");
while(!feof($myfile4))
{
